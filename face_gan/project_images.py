...
def main():
    ...
    parser.add_argument('--src_dir', default='aligned_images/', help='Directory with aligned images for projection')
    parser.add_argument('--dst_dir', default='generated_images/', help='Output directory')
    parser.add_argument('--tmp-dir', default='.stylegan2-tmp', help='Temporary directory for tfrecords and video frames')
    parser.add_argument('--network-pkl', default='networks/normal_face.pkl', help='StyleGAN2 network pickle filename')
    parser.add_argument('--vgg16-pkl', default='./encoder_model/vgg16_zhang_perceptual.pkl', help='VGG16 network pickle filename')
